...
void XmlManagerTest::testSaveAndLoadMediaItems() {
    ...
    Film* film = new Film(std::string("Mannaggia"), std::string("Aldo Giovanni e Jack"), std::string("1999"), std::string("Medusa"), std::string("Comedy"), tags, std::string("DVD"), std::string("Italian"), std::string("No"), std::string("120"), std::string("Digital"), 24, std::string("Aldo Giovanni e Jack"));
    Podcast* podcast = new Podcast(std::string("Mannaggia"), std::string("Aldo Giovanni e Jack"), std::string("1999"), std::string("Medusa"), std::string("Comedy"), tags, std::string("DVD"), std::string("Italian"), std::string("No"), std::string("120"), 24);
    Music* music = new Music(std::string("Mannaggia"), std::string("Aldo Giovanni e Jack"), std::string("1999"), std::string("Medusa"), std::string("Comedy"), tags, std::string("DVD"), std::string("Italian"), std::string("No"), std::string("120"), std::string("Aldo Giovanni e Jack"));
