...
public:
    Podcast(const std::string& title = "", const std::string& author = "", const std::string& releaseDate = "", const std::string& productionHouse = "", 
                ...
                const std::string& format = "", const std::string& language = "", const bool used = false, const unsigned int duration = 0, const unsigned int episode = 0, const std::string& image = "");
