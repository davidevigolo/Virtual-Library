...
Article::Article(const std::string& title, const std::string& author, const std::string& releaseDate, const std::string& productionHouse, 
                ...
                const std::string& format, const std::string& language, const bool used, const std::string edition, const unsigned int pages, const std::string& publisher, const std::string& image):
