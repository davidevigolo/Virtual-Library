...
void XmlVisitor::visit(MediaItem* media, bool onlyBody){
...
void XmlVisitor::visit(AudioVisual* media, bool onlyBody){
    if(!onlyBody) writer.writeStartElement("AudioVisual");
    visit(static_cast<MediaItem*>(media), true);
    writer.writeTextElement("Duration", media->getDuration().c_str());
    if (!onlyBody) writer.writeEndElement();
}

void XmlVisitor::visit(Film* media, bool onlyBody){
    if(!onlyBody) writer.writeStartElement("Film");
    visit(static_cast<AudioVisual*>(media), true);
...
void XmlVisitor::visit(Podcast* media, bool onlyBody){
...
void XmlVisitor::visit(Music* media, bool onlyBody){
